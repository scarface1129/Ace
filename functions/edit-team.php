...
$team_values = ['name'=>$name,'numberOfPlayers'=>$numberOfPlayers,'about_team'=>$about_team,'logo'=>$logo['name'],'seekingPlayers'=>$seeking_players,'phoneNumber'=>$phone,'email'=>$email,'instagramHandle'=>$instagram,'facebookLink'=>$facebook];
if (empty($name)) {
