...
<!-- Mirrored from h-sportak.torbara.com/yellow/match-list.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jul 2022 23:29:14 GMT -->
<head>
                ...
                <nav style="margin: 0px;" class="tm-navbar uk-navbar" data-uk-sticky="">
                    <div class="uk-container uk-container-center">
                        ...
                        <ul class="uk-navbar-nav uk-hidden-small">
                            ...
                            <li class="uk-parent uk-active" data-uk-dropdown="{'preventflip':'y'}" aria-haspopup="true" aria-expanded="false"><a href="match-list.html">Match</a>
                                <div class="uk-dropdown uk-dropdown-navbar uk-dropdown-width-1">
                                    <div class="uk-grid uk-dropdown-grid">
                                        <div class="uk-width-1-1">
                                            <ul class="uk-nav uk-nav-navbar">
...
<!-- Mirrored from h-sportak.torbara.com/yellow/match-list.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jul 2022 23:30:29 GMT -->
</html>